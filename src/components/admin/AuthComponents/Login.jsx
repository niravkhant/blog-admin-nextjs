    ...
    <section>
      <div className="absolute inset-0 w-full h-full flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
        <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
          ...
          <h2 className="text-center text-2xl font-bold leading-tight text-black">Sign in to Blog Admin</h2>
          <p className="mt-2 text-center text-sm text-gray-600 ">
            Don't have an account?
            <Link href="/admin/register" title="" className="font-semibold text-black transition-all duration-200 hover:underline">
              Create account
            </Link>
          </p>
